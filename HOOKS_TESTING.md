...
✗ test-related: FAILED - Tests bailed after first failure (better-sqlite3 issue)
...
$ bun run lint    # ✓ Works
$ bun run check   # ✓ Works
$ bun test --run  # ✓ Works (310 pass, 17 fail due to better-sqlite3)
...
1. `/Users/mg/Developer/zo/zorter/lefthook.yml` - Main hook configuration
2. `/Users/mg/Developer/zo/zorter/.lefthook-local.yml.example` - Local customization template
3. `/Users/mg/Developer/zo/zorter/.gitignore` - Added `.lefthook-local.yml`
4. `/Users/mg/Developer/zo/zorter/README.md` - Added "Git Hooks" section
